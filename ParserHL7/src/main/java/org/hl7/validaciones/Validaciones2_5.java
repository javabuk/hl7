...
/**
 * Clase para añadir validaciones al mensaje.  Definidas en http://hl7api.sourceforge.net/base/apidocs/ca/uhn/hl7v2/validation/builder/class-use/Predicate.html
 * @author Jorge
 *
 */
public class Validaciones2_5 extends DefaultValidationBuilder {
	...
	protected void configure() {
		...
		//forVersion(Version.V25).message("ADT", "*").terser("PID-2", not(empty()));
		// Validamos que el campo emisor sea MEDIKOSTA
		//forVersion(Version.V25).message("ADT", "*").terser("MSH-3-1", isEqualIgnoreCase("MEDIKOSTA"));
